...
namespace lingToSqlVideo_
{
    ...
    partial void DeleteMusteriler(Musteriler instance);
		...
		public VideoDataContext() : 
				base(global::lingToSqlVideo_.Properties.Settings.Default.VideoMarketConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnMiktarChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Yonetmen", DbType="VarChar(100) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Oyuncular", DbType="VarChar(MAX) NOT NULL", CanBeNull=false)]
